...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://wwkdivd58i.execute-api.us-east-1.amazonaws.com/test1';
    ...
    apigClient.lFDiningOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var lFDiningOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/LF_dining').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(lFDiningOptionsRequest, authType, additionalParams, config.apiKey);
    };
